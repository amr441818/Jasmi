...
import logoImg from '../../../public/assets/images/Layer 1.png'
            ...
            >
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex  justify-between items-center px-6 py-3">
                        <NavLink to="/" className="main-logo justify-center flex items-center w-full shrink-0">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/clients" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('clints')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item">
